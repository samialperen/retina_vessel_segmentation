...
#patches_imgs_test vardı model predict argumani olarak
predictions = model.predict(test_imgs_orig, batch_size=32, verbose=2)
print "predicted images size :"
print predictions.shape
pred_imgs = None
#===== Convert the prediction arrays in corresponding images
pred_imgs = pred_to_imgs(predictions, full_img_height, full_img_width, "original")
